// Added createPortal and useRef to render popup outside navbar hierarchy
...
const StreakCounter = () => {
  ...
  // Stores popup position on screen
  const [popupPos, setPopupPos] = useState({ top: 0, left: 0 });

  // Reference to streak counter container for positioning popup
  ...
  // Required because popup is rendered using React Portal.
  useEffect(() => {
  ...
  // Render popup using React Portal to avoid stacking/z-index issues
        ...
        >
          ...
          <div
            style={{
              ...
              borderTop: '1px solid rgba(255, 140, 77, 0.3)',
              borderLeft: '1px solid rgba(255, 140, 77, 0.3)',
            }}
          />

          <h3 style={{ margin: '0 0 4px 0', fontSize: '1.1rem', color: '#ff8c4d' }}>
            {computedStreak} Day Streak
          </h3>
          <p style={{ margin: '0 0 16px 0', fontSize: '0.8rem', color: 'rgba(255,255,255,0.6)' }}>
            Max Streak: {computedMaxStreak}
          </p>
            ...
            {last7Days.map(day => {
              ...
              return (
                <div key={day.dateKey} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                  ...
                  <span style={{
                    fontSize: '0.65rem',
                    color: day.isToday ? '#ff8c4d' : 'rgba(255,255,255,0.5)',
