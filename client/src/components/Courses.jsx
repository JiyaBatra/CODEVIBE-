...
const Courses = () => {
  ...
  const courses = [
    ...
    { title: 'Graph Algorithms', prefix: 'graph', total: 10, desc: 'Discover graph traversal, shortest paths, and MSTs.', img: dsaLogo, link: '/GraphLesson', level: 'Advanced', duration: '10 lessons', time: '4h 20m', category: 'Programming' },
    { title: 'Tree Data Structures', prefix: 'tree', total: 10, desc: 'Master trees, BSTs, and advanced tree DP patterns.', img: dsaLogo, link: '/TreeLesson', level: 'Advanced', duration: '10 lessons', time: '4h 10m', category: 'Programming' },
    { title: 'Dynamic Programming', prefix: 'dp', total: 10, desc: 'Solve optimization problems using DP patterns.', img: dsaLogo, link: '/DPLesson', level: 'Advanced', duration: '10 lessons', time: '5h', category: 'Programming' },
